#!/usr/bin/env python3
"""
GRACE Basin Identification via Rotated EOFs (Masked Batch Generation) - not deseasonalized
...
MASK_XYZ_FILE = "Asia.xyz"         # Path to your .XYZ mask file
N_MODES_TO_ROTATE = 5                   # Total number of modes to calculate
OUTPUT_DIR = "asia_output/seasons"            # Folder where all maps will be saved
